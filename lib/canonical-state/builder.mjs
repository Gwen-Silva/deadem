...
export async function buildCanonicalState(manifest, io, { clean = false } = {}) {
    ...
    if (categoryEnabled(manifest, 'player_death')) {
        for (const event of inputs.deathEvents.events) {
            events.push(makeEvent(manifest, {
                ...
                epistemicStatus: { confidence: event.confidence, semanticLimit: 'death is factual; killer/assist/cause/fight quality are not canonical direct facts in Task 085', warnings: event.validationFlags }
            }));
        }
    }
    ...
    const nonTimelineMetadata = {
        ...
        records: [
            ...
            { metadataId: 'raw_replay_identity_hash', category: 'raw_replay_identity', value: inputs.rawReplay, provenance: provenance(manifest, { sourceId: 'rawReplay', sourceField: 'sha256', epistemicType: 'deterministic_derivation', method: 'hashed raw replay only to verify identity; replay was not parsed in Task 085' }) }
        ]
    };
    ...
    const targetEventDiff = diffVariantSet(contractEventVariantSchemas, replay002Schemas.factualEventVariants, 'factualEventVariants', { source: 'contract_v4', target: manifest.replayId });
    const targetMetadataDiff = diffVariantSet(contractMetadataVariantSchemas, Object.fromEntries(nonTimelineMetadata.records.map(record => [record.metadataId, inferSchema(record.value)])), 'metadataVariants', { source: 'contract_v4', target: manifest.replayId });
    const targetContractDiffs = [
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.playerRegistry), replay002Schemas.playerRegistry, 'playerRegistry', { source: 'contract_v4', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.entityRegistry), replay002Schemas.entityRegistry, 'entityRegistry', { source: 'contract_v4', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.nonTimelineMetadata), replay002Schemas.metadata, 'metadata', { source: 'contract_v4', target: manifest.replayId }),
        ...targetMetadataDiff.diffs,
        ...targetEventDiff.diffs,
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.independentValidationOverlay), replay002Schemas.overlay, 'overlay', { source: 'contract_v4', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.snapshot), replay002Schemas.snapshots, 'snapshots[]', { source: 'contract_v4', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.capabilityMatrix), replay002Schemas.capabilities, 'capabilityMatrix', { source: 'contract_v4', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.validationSummary), replay002Schemas.validation, 'validationSummary', { source: 'contract_v4', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.canonicalStateGate), replay002Schemas.gate, 'canonicalGate', { source: 'contract_v4', target: manifest.replayId })
    ];
    ...
    const replay009VsContract = [
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.playerRegistry), replay009Schemas.playerRegistry, 'playerRegistry', { source: 'contract_v4', target: referenceReplayLabel }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.entityRegistry), replay009Schemas.entityRegistry, 'entityRegistry', { source: 'contract_v4', target: referenceReplayLabel }),
        ...diffVariantSet(contractEventVariantSchemas, replay009Schemas.factualEventVariants, 'factualEventVariants', { source: 'contract_v4', target: referenceReplayLabel }).diffs
    ...
    const replay009VsReplay002 = [
        ...
        ...diffSchema(replay009Schemas.metadata, replay002Schemas.metadata, 'metadata', { source: referenceReplayLabel, target: `${manifest.replayId}_v4` }),
        ...diffSchema(replay009Schemas.overlay, replay002Schemas.overlay, 'overlay', { source: referenceReplayLabel, target: `${manifest.replayId}_v4` }),
        ...diffSchema(replay009Schemas.snapshots, replay002Schemas.snapshots, 'snapshots[]', { source: referenceReplayLabel, target: `${manifest.replayId}_v4` }),
        ...diffSchema(replay009Schemas.capabilities, replay002Schemas.capabilities, 'capabilityMatrix', { source: referenceReplayLabel, target: `${manifest.replayId}_v4` }),
        ...diffSchema(replay009Schemas.validation, replay002Schemas.validation, 'validationSummary', { source: referenceReplayLabel, target: `${manifest.replayId}_v4` })
    ...
    const crossEventDiff = diffVariantSet(replay009Schemas.factualEventVariants, replay002Schemas.factualEventVariants, 'factualEventVariants', { source: referenceReplayLabel, target: `${manifest.replayId}_v4` });
    ...
    const schemaDiff = {
        ...
        replay009V1VersusContractV4: { differences: replay009VsContract },
        replay009V1VersusReplay002V4: { differences: replay009VsReplay002 },
    ...
    const documentationConsistency = {
        ...
        nextMilestoneMentionsTask085: manifest.taskId === '085',
        replay002NotClaimedReadyBeforeV4: true
    };
    ...
    const validationMatrix = {
        ...
        targetSchemaBreaks: schemaDiff.targetV4VersusContractV4.schemaBreaks,
