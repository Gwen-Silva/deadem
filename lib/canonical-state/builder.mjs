...
export function collectVariants(events) {
...
export function contractToShape(schema) {
...
export async function buildCanonicalState(manifest, io, { clean = false } = {}) {
    ...
    if (categoryEnabled(manifest, 'player_death')) {
        for (const event of inputs.deathEvents.events) {
            events.push(makeEvent(manifest, {
                ...
                epistemicStatus: { confidence: event.confidence, semanticLimit: 'death is factual; killer/assist/cause/fight quality are not canonical direct facts in Task 087', warnings: event.validationFlags }
            }));
        }
    }
    ...
    const nonTimelineMetadata = {
        ...
        records: [
            ...
            { metadataId: 'raw_replay_identity_hash', category: 'raw_replay_identity', value: inputs.rawReplay, provenance: provenance(manifest, { sourceId: 'rawReplay', sourceField: 'sha256', epistemicType: 'deterministic_derivation', method: 'hashed raw replay only to verify identity; replay was not parsed in Task 087' }) }
        ]
    };
    ...
    const targetEventDiff = diffVariantSet(contractEventVariantSchemas, replay002Schemas.factualEventVariants, 'factualEventVariants', { source: 'contract_v6', target: manifest.replayId });
    const targetMetadataDiff = diffVariantSet(contractMetadataVariantSchemas, Object.fromEntries(nonTimelineMetadata.records.map(record => [record.metadataId, inferSchema(record.value)])), 'metadataVariants', { source: 'contract_v6', target: manifest.replayId });
    const targetContractDiffs = [
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.playerRegistry), replay002Schemas.playerRegistry, 'playerRegistry', { source: 'contract_v6', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.entityRegistry), replay002Schemas.entityRegistry, 'entityRegistry', { source: 'contract_v6', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.nonTimelineMetadata), replay002Schemas.metadata, 'metadata', { source: 'contract_v6', target: manifest.replayId }),
        ...targetMetadataDiff.diffs,
        ...targetEventDiff.diffs,
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.independentValidationOverlay), replay002Schemas.overlay, 'overlay', { source: 'contract_v6', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.snapshot), replay002Schemas.snapshots, 'snapshots[]', { source: 'contract_v6', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.capabilityMatrix), replay002Schemas.capabilities, 'capabilityMatrix', { source: 'contract_v6', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.validationSummary), replay002Schemas.validation, 'validationSummary', { source: 'contract_v6', target: manifest.replayId }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.canonicalStateGate), replay002Schemas.gate, 'canonicalGate', { source: 'contract_v6', target: manifest.replayId })
    ];
    ...
    const replay009VsContract = [
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.playerRegistry), replay009Schemas.playerRegistry, 'playerRegistry', { source: 'contract_v6', target: referenceReplayLabel }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.entityRegistry), replay009Schemas.entityRegistry, 'entityRegistry', { source: 'contract_v6', target: referenceReplayLabel }),
        ...diffVariantSet(contractEventVariantSchemas, replay009Schemas.factualEventVariants, 'factualEventVariants', { source: 'contract_v6', target: referenceReplayLabel }).diffs,
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.nonTimelineMetadata), replay009Schemas.metadata, 'metadata', { source: 'contract_v6', target: referenceReplayLabel }),
        ...diffVariantSet(contractMetadataVariantSchemas, {}, 'metadataVariants', { source: 'contract_v6', target: referenceReplayLabel }).diffs.map(diff => ({ ...diff, classification: 'missing_historical_artifact' })),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.independentValidationOverlay), replay009Schemas.overlay, 'overlay', { source: 'contract_v6', target: referenceReplayLabel }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.snapshot), replay009Schemas.snapshots, 'snapshots[]', { source: 'contract_v6', target: referenceReplayLabel }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.capabilityMatrix), replay009Schemas.capabilities, 'capabilityMatrix', { source: 'contract_v6', target: referenceReplayLabel }),
        ...diffSchema(contractToShape(CANONICAL_CONTRACT.artifacts.validationSummary), replay009Schemas.validation, 'validationSummary', { source: 'contract_v6', target: referenceReplayLabel }),
        { path: 'canonicalGate', source: 'contract_v6', target: referenceReplayLabel, previousType: contractToShape(CANONICAL_CONTRACT.artifacts.canonicalStateGate), newType: null, classification: 'missing_historical_artifact', justification: 'replay 009 v1 package predates canonical-state-gate artifact', impact: 'migration_required', adapterRequired: true }
    ...
    const replay009VsReplay002 = [
        ...diffSchema(replay009Schemas.playerRegistry, replay002Schemas.playerRegistry, 'playerRegistry', { source: referenceReplayLabel, target: `${manifest.replayId}_v6` }),
        ...diffSchema(replay009Schemas.entityRegistry, replay002Schemas.entityRegistry, 'entityRegistry', { source: referenceReplayLabel, target: `${manifest.replayId}_v6` }),
        ...diffSchema(replay009Schemas.metadata, replay002Schemas.metadata, 'metadata', { source: referenceReplayLabel, target: `${manifest.replayId}_v6` }),
        ...diffSchema(replay009Schemas.overlay, replay002Schemas.overlay, 'overlay', { source: referenceReplayLabel, target: `${manifest.replayId}_v6` }),
        ...diffSchema(replay009Schemas.snapshots, replay002Schemas.snapshots, 'snapshots[]', { source: referenceReplayLabel, target: `${manifest.replayId}_v6` }),
        ...diffSchema(replay009Schemas.capabilities, replay002Schemas.capabilities, 'capabilityMatrix', { source: referenceReplayLabel, target: `${manifest.replayId}_v6` }),
        ...diffSchema(replay009Schemas.validation, replay002Schemas.validation, 'validationSummary', { source: referenceReplayLabel, target: `${manifest.replayId}_v6` })
    ...
    const crossEventDiff = diffVariantSet(replay009Schemas.factualEventVariants, replay002Schemas.factualEventVariants, 'factualEventVariants', { source: referenceReplayLabel, target: `${manifest.replayId}_v6` });
    ...
    const schemaDiffCoverage = {
        ...
        comparisons: [
            {
                comparison: 'targetReplay002V6VersusContractV6',
            ...
            {
                comparison: 'replay009V1VersusReplay002V6',
    ...
    const schemaDiff = {
        ...
        replay009V1VersusContractV6: { differences: replay009VsContract },
        replay009V1VersusReplay002V6: { differences: replay009VsReplay002 },
        ...
        replay002VsReplay009KnownDifferences: [
            { category: 'entity_identity', classification: 'identity_model_difference', description: 'Replay 002 V6 preserves neutral raw-handle entity keys while replay 009 v1 uses its earlier canonical identity shape.' }
        ],
        schemaDiffCoverage,
    ...
    const documentationConsistency = {
        ...
        replay002NotClaimedReadyBeforeV6: true
    };
    ...
    await io.writeJson(path.join(manifest.assessmentDir, 'candidate-generation-summary.json'), correctionSummary);
    ...
    return {
        ...
        validationSummary,
        candidateAudits: {
            rawReplayAccessClassification,
            assumptionAudit,
            identityAudit,
            spatialLeakageAudit: { schemaVersion: 1, findings: spatialFindings, passed: spatialFindings.length === 0 },
            provenanceAudit,
            canonicalSchemaValidation: schemaValidation,
            canonicalSchemaDiff: schemaDiff,
            schemaDiffCoverage,
            manifestBehaviorValidation,
            contractCompletenessAudit,
            contractSourceConsistency,
            documentationConsistency,
            ioPolicyAudit,
            protectionsAudit,
            directObservationJustification,
            validationMatrix
        }
    };
}
