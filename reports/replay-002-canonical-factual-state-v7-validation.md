# Replay 002 Canonical Factual State v7 Validation

## Gate

`replay_002_canonical_factual_state_ready_with_constraints_v7`
...
- Schema ledger entries: 27
- Schema coverage missing comparisons: 0
- IO findings: 41, forbidden findings: 0
- Documentation rules: 11
- Full-pipeline deterministic: true
- Base audit manifest verified: null
