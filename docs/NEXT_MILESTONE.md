...
Task 087 is the active corrective audit closure for this case. Its gate is
`replay_002_canonical_factual_state_ready_with_constraints_v6`. Replay 002 now
...
`tasks/blocked/088-select-next-canonical-generalization-control.md`.
