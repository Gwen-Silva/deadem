...
`output/replay-002-canonical/` contains the Task 085 v4 canonical
...
`output/replay-002-canonical-v4-validation/` contains the accepted Task 085
...
schema diff, manifest behavior validation, deterministic rerun result,
validation matrix, summary, and gate.
...
review; use the Task 085 v4 package for current replay-002 canonical evidence. These
outputs do not emit
