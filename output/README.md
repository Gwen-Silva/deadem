...
`output/replay-002-canonical/` contains the Task 088 v7 canonical
...
`output/replay-002-canonical-v7-validation/` contains the accepted Task 088
...
review; use the Task 088 v7 package for current replay-002 canonical evidence. These
outputs do not emit
