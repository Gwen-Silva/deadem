...
const DEFAULT_ASSESSMENT = 'output/replay-002-canonical-v4-validation';
...
export async function createReplay002Manifest(options = {}) {
    ...
    return {
        ...
        taskId: '085',
        replayId: 'replay_002',
        eventIdPrefix: 'canon002v4',
        parserMatrixReplayId: 'replay_002',
        rawReplay: { path: sources.rawReplay.path, accessMode: 'raw_replay_identity_hash_verified' },
        outputDir,
        assessmentDir,
        expectedGate: 'replay_002_canonical_factual_state_ready_with_constraints_v4',
        blockedGate: 'replay_002_canonical_factual_state_v4_blocked',
        ...
        followUpTaskPath: 'tasks/blocked/086-select-next-canonical-generalization-control.md',
        pipelineModules: [
