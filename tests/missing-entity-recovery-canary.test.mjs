...
test('Task 107 does not exist', () => {
    assert.equal(existsSync('tasks/specs/107.json'), false);
    assert.equal(existsSync('tasks/blocked/107-select-next-canonical-generalization-control.md'), false);
});
