...
test('Task 108 does not exist', () => {
    assert.equal(existsSync('tasks/specs/108.json'), false);
    assert.equal(existsSync('tasks/blocked/108-select-next-canonical-generalization-control.md'), false);
});
